                      ...
                      <div key={a.id} style={{background:"#fff",border:`2px solid ${isAlert?"#fecaca":isWarn?"#fde68a":"#e2e8f0"}`,borderRadius:12,overflow:"hidden",boxShadow:"0 2px 6px rgba(0,0,0,0.05)"}}>
                        ...
                        <div style={{padding:"12px 10px 6px"}}>
                          <ResponsiveContainer width="100%" height={180}>
                            <LineChart data={chartData} margin={{top:8,right:14,bottom:4,left:0}}>
                              ...
                              <Tooltip content={<DashTooltip units={{[activeSensor]:unit}}/>}/>
                              ...
                              <Line type="monotone" dataKey={activeSensor} stroke={a.color} strokeWidth={2} dot={false} name={activeSensor}/>
                            </LineChart>
                          </ResponsiveContainer>
                        </div>
                      </div>
